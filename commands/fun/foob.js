...
module.exports = {
    name: 'foob',
    category: 'fun',
    description: 'Send a random image of Shirakami Fubuki',
    usage: `foob`,
    run: async (client, message) => {

        const url = `post/index.json?limit=1&tags=${message?.channel?.nsfw ? '' : 'rating:s+'}+order:random+shirakami_fubuki`; // we do a little trolling pepeLa
